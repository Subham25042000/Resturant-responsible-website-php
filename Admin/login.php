...
.login-box {
	...
	border-radius: 10px;
	box-shadow: 0px 0px 10px #0b0404c4;
	margin: 10% auto;
	padding: 20px;
	text-align: center;
	width: 400px;
...
<body>
	...
	if(isset($_POST['submit'])){
		// $username = mysql i_real_escape_string($conn, $_POST['username']);
		// $password = mysql i_real_escape_string($conn, $_POST['password']);
